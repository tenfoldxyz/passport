export { TenOrMoreGithubFollowers, FiftyOrMoreGithubFollowers } from "./githubFollowers";
...
export { FiveOrMoreCommitsOnGithubRepo } from "./githubFiveOrMoreCommitsOnRepo";
